...
const NavBar = ({ handleScrollOnClick }) => {
  return (
    <div className='nav-icon-div'>
      ...
      <a href='https://docs.google.com/document/d/1BgJrRqY7EziTPKyjEBWZFsmFEyREiFeB/edit?usp=share_link&ouid=113510718493931215820&rtpof=true&sd=true' target='_blank' rel='noopener noreferrer'>
